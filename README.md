# TopPop
### Description
Top Pop is simple app which connects to Deezer API and presents you top 10 tracks on the Chart with some fancy colors. If you want, you can also sort tracks ascending or descending by their duration.  
